...
base_dir = f"../test_result/reduce_MOMXY_{Objective_T_period}inputs_4var/{Control_purpose}_{optimal_inputs}_{current_time}"
...
def plot_PREC(TEST_prec_matrix, TEST_CTRL_prec_matrix, Objective_ratio):
    ...
    plt.savefig(os.path.join(out_dir, f"LonLat_{Objective_ratio}%.png"), dpi=1200)
    ...
    plt.savefig(os.path.join(out_dir, f"Sub_LonLat_{Objective_ratio}%.png"), dpi=1200)
